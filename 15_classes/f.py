...
# пусть сам класс следит за кол-вом объектов
class Lemming:
    # можно определять атрибуты на уровне класса, тогда они
    # "привязаны" к классу
    total = 0
...
class Lemming:
    # можно определять атрибуты на уровне
    # класса, тогда они "привязаны" к классу
    total = 0
