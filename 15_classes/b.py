...
# Атрибуты сохраняются в пространстве имен
# каждого объекта - у разных объектов они м.б. разные
...
# можно устанавливать атрибуты динамически, по именам
for attr_name in ('weight', 'height',):
    setattr(robot, attr_name, 42)
print(hasattr(robot, 'weight'))
print(robot.weight)

# getattr(obj, name, default = None) - получение атрибута
